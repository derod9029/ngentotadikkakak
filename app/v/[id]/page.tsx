...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepcolmekmuncrat.pages.dev/v/${file.filecode}#${file.title}`,
